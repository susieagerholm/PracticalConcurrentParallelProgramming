...
public class TestCache {
  public static void main(String[] args) throws InterruptedException {
	...
	//cachingFactorizer.compute(p);
    
    //Testing wrapper
    Computable<Long, long[]> factorizer = new Factorizer();
	//final Computable<Long, long[]> cachingFactorizer = new Memoizer0<Long,long[]>(factorizer);	
	Mark7("ExerciseMemoizer0", 
            i -> exerciseFactorizer(factorizer));
 ...
 private static int exerciseFactorizer(Computable<Long, long[]> f) { 
