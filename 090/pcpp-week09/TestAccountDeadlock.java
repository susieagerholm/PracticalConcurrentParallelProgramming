...
public class TestAccountDeadlock {
  public static void main(String[] args) {
	...
	for (int i=0; i<transfers; i++) 
	  //System.out.println("CLERK2: Started transfers...");		
...
class Account {
  ...
  public synchronized void deposit(long amount) {
	...
	//System.out.println( name + " has taken lock of: " + this.toString());  
    balance += amount;
  }
  ...
  public void transferC(Account that, long amount) {
	String name = Thread.currentThread().getName();
	System.out.println( name + " intends to take lock of: " + this.toString());
    System.out.println( name + " intends to take lock of: " + that.toString());
    
    synchronized (this) { synchronized(that) {
	System.out.println( name + " has taken lock of: " + this.toString());
    System.out.println( name + " has taken lock of: " + that.toString());	
