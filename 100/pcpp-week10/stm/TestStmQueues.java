...
public class TestStmQueues extends Tests {
  ...
  private static void sequentialTest(StmBoundedQueue<Integer> bq) throws Exception {
  ...
  /* private static void parallelTest(StmBoundedQueue<Integer> bq) throws Exception {
